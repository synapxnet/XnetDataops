...
public interface QualityRuleMapper {
    ...
    /**
     * 根据稳定报告 UID 查询质量报告。 English: Query one quality report by its stable UID, returning null when absent.
     *
     * @param uid 报告 UID
    ...
    /**
     * 查询指定报告产生的质量告警。 English: Read the alerts generated by the specified report in descending trigger order.
     *

...
public final class AgentContract {
    ...
    /**
     * 阻止工具类被实例化。
 * English: Prevent instantiation of this static contract utility.
 */
 ...
 * English: Read verified request context and require the path, headers and body to identify the same tool.
 */
     ...
     * @param <T> 领域响应类型
     * @return 成功工具响应
 * English: Build a successful tool response with request metadata and an evidence digest.
 */
     ...
     * @param <T> 动作响应类型
     * @return 写工具成功响应
 * English: Build a successful tool response containing the supplied audit receipt.
 */
 ...
 * English: Return a new immutable context containing the supplied request ID.
 */

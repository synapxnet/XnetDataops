 ...
 * English: Construct a nonretryable public exception with no structured details.
 */
 ...
 * English: Construct a public exception with the supplied status, retry flag and safe details.
 */
    ...
    /** 获取 HTTP 状态码。
 * English: Return the configured HTTP status code.
 */
    ...
    /** 获取公共错误码。
 * English: Return the stable public error code.
 */
    ...
    /** 判断调用方是否可重试。
 * English: Return whether the caller may retry this failure.
 */
    ...
    /** 获取已脱敏的结构化详情。
 * English: Return the supplied sanitized structured details.
 */

 ...
 * English: Configure the signing secret and audience; verification fails closed when the secret is absent.
 */
     ...
     * @return 可信 actorId
 * English: Verify token signature and bounded claims, then return the authorized subject.
 */
     ...
     * @return JSON 对象
 * English: Decode one Base64URL JWT segment into a JSON object.
 */
     ...
     * @return 原始签名字节
 * English: Compute the HMAC-SHA256 signature of the supplied signing input.
 */
     ...
     * @param toolName 请求工具
 * English: Validate token lifetime, audience, workspace and allowed tool against the request.
 */

...
public interface WorkflowMapper {
    ...
    /**
     * 根据稳定实例 UID 查询任务实例。 Query one task instance by stable UID, returning null when absent.
     *
     * @param uid 任务实例 UID
    ...
    /**
     * 查询不含大日志字段的节点实例，避免默认读取 log_content。 Read node instances without selecting log_content.
     *

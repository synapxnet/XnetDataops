...
public interface WorkflowService {
    ...
    /**
     * 根据稳定 UID 获取任务实例。 English: Read the task instance by its stable UID.
     *
     * @param uid 任务实例 UID
     * @return 任务实例
     */
    ...
    /**
     * 按需读取节点实例日志；关闭时 SQL 完全不选择大日志字段。 English: Read node logs only when requested; otherwise select no log content column.
     *
